...
var ravensBest = {
    ...
    share: function() {
        $(".icon-twitter").on("click", function() {
            var tweet = $(this).attr("data-shareText") + " - remember this play? Vote for the top Ravens moments at ";
            var url = "http://data.baltimoresun.com/sports/ravens-best-plays/%23" + $(this).attr("data-slideNum");
            var twitter_url = "https://twitter.com/intent/tweet?text=" + tweet + "&url=" + url + "&tw_p=tweetbutton";
            window.open(twitter_url, "mywin", "left=200,top=200,width=500,height=300,toolbar=1,resizable=0");
            return false;
        });
        $(".icon-facebook").on("click", function() {
            var picture = "http://data.baltimoresun.com/sports/ravens-best-plays/images/thumbnail.png";
            var title = "Readers Vote: Ravens' Best Plays";
            var description = "We chose 10 of the top plays in Ravens history. Relive them, then scroll to the bottom to rank them based on your favorites.";
            var url = "http://data.baltimoresun.com/sports/ravens-best-plays/";
